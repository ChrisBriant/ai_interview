...
@router.post("/createroleandquestionset", response_model = str)  # RoleResponseSchema, status_code=status.HTTP_201_CREATED)
...
@router.get("/getroleswithquestions", response_model = str ) # response_model = RoleResponseSchema)
